require = function e(t, n, r) {
  ...
  AdTracking: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "fbc3e0HnD1NP7p7Ek1n8IQe", "AdTracking");
    "use strict";
    ...
    cc.Class({
      ...
      start: function start() {
        this.hasSupport() && (this.adTrackingPlugin = anysdk.agentManager.getAdTrackingPlugin());
      },
    ...
    BaseAnySDKExample: "BaseAnySDKExample",
    SuspensionTips: "SuspensionTips"
  } ],
  ...
  Ads: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "5260bXDtylBwYTkP2GSV9zc", "Ads");
    "use strict";
    var SuspensionTips = require("SuspensionTips");
    cc.Class({
      extends: require("BaseAnySDKExample"),
      ...
      start: function start() {
        if (this.hasSupport()) {
          ...
          this.adsPlugin && this.adsPlugin.setListener(this.onAdsResult, this);
        }
      },
  ...
  Analytics: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "330353g9fpGm4X4QOvi6/GB", "Analytics");
    "use strict";
    var SuspensionTips = require("SuspensionTips");
    cc.Class({
      extends: require("BaseAnySDKExample"),
      properties: {},
      start: function start() {
        this.hasSupport() && (this.analyticsPlugin = anysdk.agentManager.getAnalyticsPlugin());
      },
  ...
  AnySDKItem: [ function(require, module, exports) {
    "use strict";
  ...
  AnySDKList: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "4e6b2pY7RBI3KPyFA1iin3p", "AnySDKList");
    "use strict";
    cc.Class({
      extends: cc.Component,
      properties: {
      ...
      initList: function initList() {
        var y = 0;
        this.node.height = 50 * (this.interfaceList.length + 1);
  ...
  BaseAnySDKExample: [ function(require, module, exports) {
    "use strict";
  ...
  Crash: [ function(require, module, exports) {
    ...
    cc.Class({
      ...
      properties: {},
      start: function start() {
        this.hasSupport() && (this.crashPlugin = anysdk.agentManager.getCrashPlugin());
      },
  ...
  IAP: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "4a19cSbR5dBVrKvchVpkiro", "IAP");
    "use strict";
    var SuspensionTips = require("SuspensionTips");
    cc.Class({
      extends: require("BaseAnySDKExample"),
      ...
      start: function start() {
        if (this.hasSupport()) {
          ...
          this.iapPlugin && this.iapPlugin.setListener(this.onPayResult, this);
        }
      },
  ...
  MaskCtrl: [ function(require, module, exports) {
    ...
    cc.Class({
      ...
      update: function update(dt) {
        if (cc._renderType !== cc.game.RENDER_TYPE_WEBGL && false) return;
    ...
    cc.Class({
      ...
      start: function start() {
        if (this.hasSupport()) {
          ...
          this.pushPlugin && this.pushPlugin.setListener(this.onPushResult, this);
        }
      },
  ...
  REC: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "f2295koIwFChZh8D60Ws2f/", "REC");
    "use strict";
    var SuspensionTips = require("SuspensionTips");
    cc.Class({
      extends: require("BaseAnySDKExample"),
      ...
      start: function start() {
        if (this.hasSupport()) {
          ...
          this.recPlugin && this.recPlugin.setListener(this.onRECResult, this);
        }
      },
  ...
  Share: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "b5f0bDMni5PDovfKUWhHFG3", "Share");
    "use strict";
    var SuspensionTips = require("SuspensionTips");
    cc.Class({
      extends: require("BaseAnySDKExample"),
      ...
      start: function start() {
        if (this.hasSupport()) {
          ...
          this.sharePlugin && this.sharePlugin.setListener(this.onShareResult, this);
        }
      },
      share: function share() {
        if (!this.sharePlugin) {
        ...
        var info = {
          ...
          comment: "无",
          description: "暗黑斩游戏制作演示 - Cocos Creator制造",
          imageTitle: "Dark Slash",
          imageUrl: "http://veewo.com/promo/img/darkslash_web_web_banner.png",
    ...
    cc.Class({
      ...
      start: function start() {
        if (this.hasSupport()) {
          ...
          this.socialPlugin && this.socialPlugin.setListener(this.onSocialResult, this);
        }
      },
  ...
  SuspensionTips: [ function(require, module, exports) {
    "use strict";
  ...
  User: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "936e8EugiJC24zJbx+WjeFx", "User");
    "use strict";
    var SuspensionTips = require("SuspensionTips");
    cc.Class({
      extends: require("BaseAnySDKExample"),
      ...
      start: function start() {
        if (this.hasSupport()) {
          ...
          this.userPlugin && this.userPlugin.setListener(this.onUserResult, this);
        }
      },
  ...
  VideoPlayerCtrl: [ function(require, module, exports) {
    ...
    cc.Class({
      ...
      toggleFullscreen: function toggleFullscreen() {
        if (cc.sys.isBrowser && cc.sys.browserType === cc.sys.BROWSER_TYPE_MOBILE_QQ && cc.sys.browserVersion <= 7.2 && /Nexus 6/.test(navigator.userAgent)) return cc.log("May be crash, so prohibit full screen");
      ...
      onVideoPlayerEvent: function onVideoPlayerEvent(sender, event) {
        ...
        event === cc.VideoPlayer.EventType.META_LOADED ? this.totalTime.string = this.videoPlayer.getDuration().toFixed(2) : event === cc.VideoPlayer.EventType.CLICKED && (this.videoPlayer.isPlaying() ? this.videoPlayer.pause() : this.videoPlayer.play());
      },
      ...
      update: function update() {
        this.currentTime && (this.currentTime.string = parseFloat(this.videoPlayer.currentTime.toFixed(2)));
      }
    });
    cc._RF.pop();
  }, {} ],
  ...
  fullscreenVideoPlayer: [ function(require, module, exports) {
    "use strict";
    ...
    cc.Class({
      ...
      videoPlayerEvent: function videoPlayerEvent(sender, event) {
        if (event === cc.VideoPlayer.EventType.READY_TO_PLAY) this.videoPlayer.play(); else if (event === cc.VideoPlayer.EventType.CLICKED) {
  ...
  "moving-objects": [ function(require, module, exports) {
    ...
    cc.Class({
      ...
      setMacroCulling: function setMacroCulling(enable) {
        if (cc.macro.ENABLE_CULLING === enable || true) return;
